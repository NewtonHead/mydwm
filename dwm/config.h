...
static const char *fonts[]          = { "opensans:size=10", "fontawesome:size=10" };
static const char dmenufont[]       = "opensans:size=10";
static const char col_gray1[]       = "#000000"; // background color
static const char col_gray2[]       = "#222222"; // inactive window border color
static const char col_gray3[]       = "#bbbbbb"; // font color
static const char col_gray4[]       = "#000000"; // current tag and current window font color
static const char col_cyan[]        = "#707070"; // top bar second color and active window border color
